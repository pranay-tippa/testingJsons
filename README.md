...
## Environments
- Preview: https://main--testingJsons--pranay-tippa.hlx.page/
- Live: https://main--testingJsons--pranay-tippa.hlx.live/
...
1. Open the `testingJsons` directory in your favorite IDE and start coding :)
